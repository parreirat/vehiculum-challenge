...
~~11 - Thor Generator for new Status::Pages::XXX implementations~~ **3 hours**
  - Slowly having fun and playing with ruby :)

12 - Implement CLI command stats
...
- [ ] - sparks
  ...
  - [x] - Thor Generator for basic implementation of new Status::Pages::XXX **3 hours**
